...
def main():
    ...
    all_contests = [580, 581, 582, 583, 584, 585, 586, 587, 588, 589]
    ...
    for contest in all_contests:
        min_val = X_baseline_features[baseline_features_df['contest'] == contest].min()
        max_val = X_baseline_features[baseline_features_df['contest'] == contest].max()
        ...
        X_baseline_features[baseline_features_df['contest'] == contest ] = (X_baseline_features[baseline_features_df['contest'] == contest ] - min_val ) / (max_val - min_val)
